...
class Easy_Store_Categories_Collection extends WP_Widget {
    ...
    private function widget_fields() {
        ...
        $fields = array(
            ...
            'section_layout' => array(
                ...
                'easy_store_widgets_title'        => __( 'Section Layouts', 'easy-store' ),
    ...
    public function widget( $args, $instance ) {
        ...
        $easy_store_section_layout     = empty( $instance['section_layout'] ) ? 'layout1' : $instance['section_layout'];

        echo $before_widget;
?>
            <div class="es-section-wrapper widget-section <?php echo esc_attr( $easy_store_section_layout ); ?>">
